...
public class ExpenseNoteDetailDocuments implements java.io.Serializable {
    ...
    public ExpenseNoteDetailDocuments(ExpenseNoteDetailDocuments value) {
        this.id = value.id;
        this.expenseNoteDetailId = value.expenseNoteDetailId;
    ...
    public String toString() {
        java.lang.StringBuilder sb = new java.lang.StringBuilder("ExpenseNoteDetailDocuments (");

        sb.append(id);
        sb.append(", ").append(expenseNoteDetailId);

...
public class DocStatus {
	...
	private List<DocStatusGroupAssociation> associatedProfiles = new ArrayList();
	...
	public List<DocStatusGroupAssociation> getAssociatedProfiles() {
		return associatedProfiles;
	}

	public void setAssociatedProfiles(List<DocStatusGroupAssociation> associatedProfiles) {

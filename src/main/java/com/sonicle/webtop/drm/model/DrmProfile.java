...
public class DrmProfile {
	...
	public List<ProfileMasterdata> getAssociatedCustomers() {
		return associatedCustomers;
	}

	public void setAssociatedCustomers(List<ProfileMasterdata> associatedCustomers) {
		this.associatedCustomers = associatedCustomers;
	}

	public List<ProfileSupervisedUser> getSupervisedUsers() {
		return supervisedUsers;
	}

	public void setSupervisedUsers(List<ProfileSupervisedUser> supervisedUsers) {

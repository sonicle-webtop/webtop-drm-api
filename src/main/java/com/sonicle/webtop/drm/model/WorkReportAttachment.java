...
public class WorkReportAttachment {
	...
	public String getWorkReportAttachmentId() {
		return workReportAttachmentId;
	}

	public void setWorkReportAttachmentId(String workReportAttachmentId) {
	...
	public int hashCode() {
		return new HashCodeBuilder()
				.append(getWorkReportAttachmentId())
	...
	public boolean equals(Object obj) {
		if (obj instanceof WorkReportAttachment == false) {
			return false;
		}
		if (this == obj) {
			return true;
		}
		final WorkReportAttachment otherObject = (WorkReportAttachment) obj;
		return new EqualsBuilder()
				.append(getWorkReportAttachmentId(), otherObject.getWorkReportAttachmentId())
				.isEquals();
	}

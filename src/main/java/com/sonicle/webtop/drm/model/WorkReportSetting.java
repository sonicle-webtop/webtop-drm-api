 ...
 * @author lssndrvs
 */
public class WorkReportSetting {

	private Integer workReportSettingId;
	private String domainId;
	private String warrantyText;
	private Integer workReportSequence;

	private List<WorkType> types = new ArrayList();
	private List<BusinessTrip> trips = new ArrayList();

	public Integer getWorkReportSettingId() {
		return workReportSettingId;
	}

	public void setWorkReportSettingId(Integer workReportSettingId) {
	...
	public Integer getWorkReportSequence() {
		return workReportSequence;
	}

	public void setWorkReportSequence(Integer workReportSequence) {
		this.workReportSequence = workReportSequence;
	}
